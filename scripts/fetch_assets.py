...
MANIFEST: dict[str, dict] = {
    ...
    "cyberpunk_platform": {
        "role": "預見背景 — 科幻預測實驗室的平台，讓未來區不只停在桌面小物。",
        "filename": "Cyberpunk Platform.glb",
        "url": "https://poly.pizza/m/ctQ5CDmraQ",
        "license": "Public Domain (CC0)",
        "attribution": "Poly Pizza (Cyberpunk Platform)",
        "format": "Poly Pizza page -> GLB -> convert to OBJ",
        "auto": True,
        "source": "poly_pizza",
    },
    "sci_fi_floor_tile": {
        "role": "預見背景 — 科幻地磚，形成 Prediction Core 計算區的冷色地景。",
        "filename": "Sci Fi Floor Tile.glb",
        "url": "https://poly.pizza/m/AxCAiLgvHN",
        "license": "Public Domain (CC0)",
        "attribution": "Poly Pizza (Sci Fi Floor Tile)",
        "format": "Poly Pizza page -> GLB -> convert to OBJ",
        "auto": True,
        "source": "poly_pizza",
    },
    "sci_fi_wall_3": {
        "role": "預見背景 — 科幻牆片，讓預見區讀成 AI 預測實驗室。",
        "filename": "Sci Fi Wall 3.glb",
        "url": "https://poly.pizza/m/LYWHc2jkDA",
        "license": "Public Domain (CC0)",
        "attribution": "Poly Pizza (Sci Fi Wall 3)",
        "format": "Poly Pizza page -> GLB -> convert to OBJ",
        "auto": True,
        "source": "poly_pizza",
    },
    "curtains_double": {
        "role": "眷戀背景 — 雙層窗簾，建立浪漫電影式私人記憶角落。",
        "filename": "Curtains Double.glb",
        "url": "https://poly.pizza/m/kkeII96j9N",
        "license": "Public Domain (CC0)",
        "attribution": "Poly Pizza (Curtains Double)",
        "format": "Poly Pizza page -> GLB -> convert to OBJ",
        "auto": True,
        "source": "poly_pizza",
    },
    "lamp_with_shade": {
        "role": "眷戀背景 — 有燈罩的立燈，提供暖色、浪漫、懷舊的場景重心。",
        "filename": "Lamp With Shade.glb",
        "url": "https://poly.pizza/m/1nKtMmYxLT",
        "license": "Public Domain (CC0)",
        "attribution": "Poly Pizza (Lamp With Shade)",
        "format": "Poly Pizza page -> GLB -> convert to OBJ",
        "auto": True,
        "source": "poly_pizza",
    },
    "candles": {
        "role": "眷戀背景 — 蠟燭群，補強私人記憶的柔光與儀式感。",
        "filename": "Candles.glb",
        "url": "https://poly.pizza/m/AnzHB44wlW",
        "license": "Public Domain (CC0)",
        "attribution": "Poly Pizza (Candles)",
        "format": "Poly Pizza page -> GLB -> convert to OBJ",
        "auto": True,
        "source": "poly_pizza",
    },
